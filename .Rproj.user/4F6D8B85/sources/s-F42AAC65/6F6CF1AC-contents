...
poder.teste.chisq.media(glicemia, 
                        sigma_zero = var(glicemia) - 5)
## testando para variancia menor que a variancia amostral -> poder < 1 - alpha
...
poder.teste.chisq.media(glicemia,
                        sigma_zero = var(glicemia))
## testando para variancia igual a variancia amostral -> poder = 1 - alpha
